...
Password <input type="password" name="paw"required>
<br>
<br>
<br>
...
</select> ID Number<input type="number" name="id" required>
<br>
<br>
<br>
<br>
...
<br>
<br>
Age <input type="number" name="age"min="15"max="100"required>
<br>
<br>

<div><input type="submit"name="subm"value="Add user"style="background-color:#803399;color:white;font-weight: bold;font-size: 20px;">
	 <span> <a href="changepassword.php"style="background-color: #ff80bf;text-decoration: none;font-weight: bold;"> Change password</a></span>
<br> 
 <?php
