...
<div>
	  <input type="submit"name="search"value="Search user"style="background-color:#803399;color:white;font-weight: bold;font-size: 20px;" >
	   <span> <a href="update.php"style="background-color: #ff80bf;text-decoration: none;font-weight: bold;"> Update</a></span>
</div>
